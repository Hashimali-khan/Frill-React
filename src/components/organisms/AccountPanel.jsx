...
export default function AccountPanel({ open: controlledOpen, onToggle, onClose }) {
  ...
  return (
    <>
      ...
      {/* Account Panel */}
      {/** Render panel via portal so it's outside header stacking context **/}
      {typeof document !== 'undefined' ? createPortal(
        <div
          className={cn(
            'fixed right-0 top-0 h-screen w-80 bg-white shadow-frill-lg z-70',
